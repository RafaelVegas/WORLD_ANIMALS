...
public class CountryController {
	...
	@RequestMapping(value = "search-pais" + "/{" + "id pais"
			+ "}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public WorldAnimalsResponse<CountryRest> getCountryByIdCountry(@PathVariable Long idCountry)
			throws WorldAnimalException {
		return new WorldAnimalsResponse<>("SUCESS", String.valueOf(HttpStatus.OK), "OK",
				countryService.getCountryByIdCountry(idCountry));
	}
}
